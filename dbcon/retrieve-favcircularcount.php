<?php
  header("Access-Control-Allow-Origin: *");
   ...
   try {
      $stmt 	= $pdo->prepare('SELECT COUNT(a.Circular_no) as circularfavct FROM `circular_data` as a,`favourits_circular` as b WHERE b.uploaded_emp_code =:empno AND a.Circular_no=b.circular_id');  
